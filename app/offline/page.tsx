    ...
    <div className="bg-[#fff7ff] min-h-dvh max-w-[430px] mx-auto flex flex-col relative">
      ...
      <main className="flex-1 pt-16 pb-[160px] px-5 flex flex-col gap-4">
        <div className="w-full bg-[#c9e6ff] rounded-2xl p-4 clay-card flex items-center gap-4 mt-3">
          <div className="w-14 h-14 rounded-full bg-white clay-thumb flex items-center justify-center text-3xl shrink-0">☁️✓</div>
          <div className="min-w-0">
            ...
            <p className="text-[14px] font-medium">You&apos;re offline, but your saved songs are here! ☁️✨</p>
          </div>
        </div>

        <div className="w-full bg-[#fbf0ff] rounded-2xl p-4 clay-card flex flex-col gap-2">
          <div className="flex items-center justify-between">
            <span className="font-display font-bold text-[14px]">📊 Puff Stash</span>
        ...
        <div className="w-full bg-[#f6e9ff] rounded-2xl p-4 clay-card flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-full bg-[#e9ddff] clay-thumb flex items-center justify-center text-xl">✈️</div>
            <div>
        ...
        <div className="w-full bg-[#fbf0ff] rounded-2xl p-4 clay-card flex flex-col gap-3">
          ...
          {[
            { t: "Warm Honey Milk", a: "Snooze Bear", p: 84, e: "🍯" },
            { t: "Lavender Horizon", a: "Velvet Mist", p: 38, e: "💜" },
          ].map((q) => (
            <div key={q.t} className="bg-white rounded-2xl p-3 clay-card">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-3 min-w-0">
                  <div className="w-10 h-10 rounded-2xl bg-[#f6e9ff] flex items-center justify-center text-xl">{q.e}</div>
        ...
        {[
          { t: "Velvet Blanket", a: "Cosy Pajama Band", e: "🧸" },
          { t: "Slumber Symphony", a: "Dream Puddle", e: "🐳" },
        ].map((s) => (
          <div key={s.t} className="w-full bg-white rounded-2xl p-3 clay-card flex items-center justify-between">
            <div className="flex items-center gap-3 min-w-0">
              <div className="w-12 h-12 rounded-2xl bg-[#f6e9ff] flex items-center justify-center text-2xl">{s.e}</div>
            ...
            <div className="flex gap-2">
              <span className="w-8 h-8 rounded-full bg-[#c9e6ff] flex items-center justify-center text-sm">✓</span>
              <button className="w-10 h-10 rounded-full bg-[#d5c4ff] clay-card min-w-[44px]">▶</button>
            </div>
          </div>
        ))}

        <div className="w-full bg-[#eedbff]/40 rounded-2xl p-4 clay-card flex gap-3">
