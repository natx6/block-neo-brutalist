...
import { isSaved } from "../../lib/downloads";
      ...
      <main className="flex-1 pt-16 pb-10 px-5">
        ...
        {!current ? (
          <div className="flex flex-col items-center text-center pt-10">
            ...
            <h2 className="font-display font-bold text-[22px] mt-6">{title}</h2>
            <p className="font-bold text-[14px] text-[#49454e]">{artist}</p>
          ...
          <>
            <div className="flex justify-center pt-2 pb-6">
              <div className="relative w-[280px] h-[280px] rounded-[32px] p-4 bg-white clay-card flex items-center justify-center">
                ...
                <div className="w-full h-full rounded-[22px] flex items-center justify-center gap-2 text-[#4c3f70]" style={{ background: current.bg }}>
        ...
        <div className="w-full bg-[#f6e9ff]/60 rounded-[28px] p-3 clay-card flex items-center justify-around">
          <button aria-label="Save track" className="flex flex-col items-center gap-1 min-w-[56px] min-h-[56px] justify-center">
            ...
            <span className="font-display font-bold text-[11px]">Saved</span>
          </button>
