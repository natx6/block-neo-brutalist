...
const PLAYLISTS = [
  { title: "Cloud Slumber", count: "32 tunes", bg: "#E9DCFF", emoji: "💜" },
  { title: "Tea & Rain", count: "18 tunes", bg: "#D4F7E6", emoji: "🍵" },
  { title: "Midnight Cocoa", count: "24 tunes", bg: "#FFD6B8", emoji: "🌙" },
  { title: "Starlight Hug", count: "12 tunes", bg: "#D1EEFF", emoji: "⭐" },
  { title: "Boba Dreams", count: "21 tunes", bg: "#FFE0D6", emoji: "🧋" },
  { title: "Sunny Puffs", count: "15 tunes", bg: "#FFF2B2", emoji: "☀️" },
];
...
export default function LibraryPage() {
  ...
  return (
    <div className="bg-[#fff7ff] min-h-dvh max-w-[430px] mx-auto flex flex-col relative">
      ...
      <main className="flex-1 pt-16 pb-[160px] px-5">
        ...
        <div className="grid grid-cols-2 gap-3 mt-2">
          <Link href="/playlist" className="rounded-2xl bg-white clay-card p-6 flex flex-col items-center justify-center gap-2 min-h-[140px] border-2 border-dashed border-[#d5c4ff]">
            <span className="w-12 h-12 rounded-full bg-[#d5c4ff] clay-thumb flex items-center justify-center text-2xl">＋</span>
