...
const TRACKS = [
  { t: "Cotton Candy Clouds", a: "Lofi Pillow", d: "3:28", icon: "cloud" },
  { t: "Marshmallow Sunset", a: "Sweet Pea", d: "3:14", icon: "wb_twilight" },
  { t: "Boba Rain", a: "Tea Garden", d: "2:56", icon: "coffee" },
  { t: "Lavender Fields", a: "Slumber Pup", d: "4:02", icon: "spa" },
  { t: "Starlight Hug", a: "Fluff", d: "3:41", icon: "star" },
];
    ...
    <div className="bg-[#fff7ff] min-h-dvh max-w-[430px] mx-auto flex flex-col relative">
      ...
      <main className="flex-1 pt-20 pb-10 px-5 flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button className="h-14 rounded-full bg-[#64568a] text-white font-display font-bold clay-button-active min-h-[56px] flex items-center justify-center gap-1.5">
            <Icon name="play_arrow" fill /> PLAY
          </button>
          <button className="h-14 rounded-full bg-white font-display font-bold clay-card min-h-[56px] flex items-center justify-center gap-1.5">
        ...
        <div className="flex flex-col gap-2">
          {TRACKS.map((s, i) => (
            <div key={s.t} className="bg-white rounded-2xl p-3 clay-card flex items-center gap-3">
              ...
              <div className="w-11 h-11 rounded-2xl bg-[#f6e9ff] flex items-center justify-center shrink-0">
              ...
              <span className="text-[#49454e] flex items-center">
